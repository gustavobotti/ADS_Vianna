 ...
 * @author Botti
 */
@WebServlet(name = "PessoasServlet", urlPatterns = {"/pessoas"})
public class PessoasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("logado") == null
            ...
            pessoas.add(new Pessoa("Zezin", 0, 0));
            pessoas.add(new Pessoa("Pedrin", 0, 0));
            pessoas.add(new Pessoa("Gustin", 0, 0));
            pessoas.add(new Pessoa("Marquin", 0, 0));
