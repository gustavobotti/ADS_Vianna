            ...
            <main>                 
                ...
                <div class="exercicio_ativo">
                    ...
                    <div style="text-align: center">                        
                        <h2>Bem vindo ao site ATENDENTE!</h2> <br />
                        <br />
                        <form action="regExame" method="GET">
                            Insira as informações para registrar um exame: <br/>  <br/>  <br/> 
                            Codigo: <input type="text" name="cpCod" /> <br /> 
                            CPF do cliente: <input type="text" name="cpCPF" /> <br />
                            Custo: <input type="text" name="cpCusto" /> <br /> 
                            Descrição: <input type="text" name="cpDesc" /> <br />
                            Tempo de jejum em horas: <input type="text" name="cpJejum" /> <br /> 
