<%@page import="br.vianna.model.Exame"%>
<%@page import="java.util.ArrayList"%>
<!DOCTYPE html>
<html>
    <head>
        <title>Laboratorio VJ</title>
        <meta charset="UTF-8">
        ...
        <div class="container">
                ...
                <nav class="menu">
                    <ul>
                        <li class="navOption"><a href="index.html">Home</a></li>
                         <li class="navOption"><a href="labLogin">Login</a></li>    
                    </ul>
                </nav>    
                </div>
            </header> 
            ...
            <main>                 
                <div class="exercicio_thumb">
                    <div class="thumb_header">Laboratório Análise Clíniva VJ</div>
                    <div class="thumb_text">Faça seus exames conosco</div>
                    <img class="thumb_img" src="./img/laboratorio.png" alt="laboratorio" >
                </div>
                
                <div class="exercicio_ativo">
                    <br/>
                    <div style="text-align: center">
                        <h2>Bem vindo ao site CLIENTE!</h2> <br />
                        <%
                            Exame exm = (Exame) session.getAttribute("exame");
                        %> 
                        <br /><p>Aqui estão os dados do exame: <% out.print(exm.getCodigo()); %></p><br />
                        <% out.print("Custo: "+exm.getCusto()); %> </br>
                        <% out.print("Descrição: "+exm.getDescricao()); %> </br>
                        <% out.print("Tempo de Jejum: "+exm.getTempoJejum()); %> </br>
                        <% out.print("Data de entrega: "+exm.getDataEntrega()); %> </br>
                        <% out.print("Já sairam os resultados: "+exm.isJaFoiEntregue()); %> </br>
                    </div>
<!--                    <div class="card_result">                    
                        ...
                        <div>
                            ...
                            <div class="cardText">Lorem ipsum dolor sit amet, consectetur adipising elit. In.</div>
