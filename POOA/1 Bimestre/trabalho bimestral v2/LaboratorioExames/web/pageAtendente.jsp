            ...
            <main>                 
                ...
                <div class="exercicio_ativo">
                    ...
                    <div style="text-align: center">                        
                        ...
                        <br /><a href="registraCliente">Clique aqui para registrar um novo cliente.</a>
                        <br /><a href="registraExame">Clique aqui para registrar um novo exame.</a><br/><br/>
                        <br /><form action="entrega" method="GET">
                            Para definir um exame como entregue, digite o código do mesmo: <br/>
                            Código: <input type="text" name="cpCod" />
