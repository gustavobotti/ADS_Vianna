            ...
            <main>                 
                ...
                <div class="exercicio_ativo">
                    ...
                    <div style="text-align: center">                        
                        ...
                        <br />
                        <form action="regCliente" method="GET">
                            Insira as informações para registrar um cliente: <br/>  <br/>  <br/> 
                            Login: <input type="text" name="cpLogin" /> <br /> 
                            Senha: <input type="text" name="cpSenha" /> <br />
                            Nome: <input type="text" name="cpNome" /> <br /> 
                            Telefone: <input type="text" name="cpTel" /> <br />
                            Endereço: <input type="text" name="cpEnd" /> <br /> 
                            CPF: <input type="text" name="cpCPF" /> <br />
                            Plano de saúde:     <select name="cpPlano">
                                                        <option value="Nenhum">Nenhum</option>
                                                        <option value="UniSaude">UniSaude</option>
                                                        <option value="PlanMed">PlanMed</option>
                                                        <option value="SaudeMais">SaudeMais</option>
                                                        </select><br />
                            Sexo:                       <select name="cpSexo">
