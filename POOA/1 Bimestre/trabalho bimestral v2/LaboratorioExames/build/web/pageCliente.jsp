        ...
        <div class="container">
            ...
            <main>                 
                ...
                <div class="exercicio_ativo">
                    <br/>
                    <form action="consultar" method="GET" style="text-align: center">
                        <h2>Bem vindo ao site CLIENTE!</h2> <br />
                        <br /><p>Para consultar o estado de um exame, digite o código do mesmo:</p><br /> 
                        Código: <input type="text" name="cpCod" /> <button type="submit" >OK</button>
                    </form>
