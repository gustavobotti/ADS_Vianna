 ...
 * @author Botti
 */
@WebServlet(name = "ConsultaExameServlet", urlPatterns = {"/consultar"})
public class ConsultaExameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Exame exame : exames){
            ...
            i++;
            if (c == codigo && exame.getPessoa() == pessoa){ // checa se cod digitado existe em algum exame, e se sim, se ele pertence a pessoa logada
                                 
                RequestDispatcher rd = request.getRequestDispatcher("pageConsulta.jsp");        
