...
import br.edu.vianna.todo.controller.action.impl.EndExameAction;
import br.edu.vianna.todo.controller.action.impl.CallEditExamePageAction;
import br.edu.vianna.todo.controller.action.impl.DeleteExameAction;
import br.edu.vianna.todo.controller.action.impl.FinishExamePageAction;
import br.edu.vianna.todo.controller.action.impl.SaveExameAction;
...
public class ControleServlet extends HttpServlet {
    ...
    public ControleServlet() {
        ...
        comandos.put("exame", new CallExameListPageAction());            
        comandos.put("newExame", new CallExamePageAction());            
        comandos.put("saveExame", new SaveExameAction());            
        comandos.put("finishExame", new FinishExamePageAction());            
        comandos.put("delExame", new DeleteExameAction());            
        comandos.put("editExame", new CallEditExamePageAction());            
        comandos.put("endExame", new EndExameAction());            
        comandos.put("relatorio", new RelatorioPageAction());            
        }
    }    
    static {
        comandos.put(null, new CallHomePageAction());
