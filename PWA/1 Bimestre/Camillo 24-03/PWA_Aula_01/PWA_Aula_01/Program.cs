...
namespace PWA_Aula_01
{
    class Program
    {
        ...
        {
            Console.WriteLine("Olá extension methods!".EntreAspas());
            Console.WriteLine("Olá extension methods!".Entre("-x-"));

            //var obj = new Atleta { Nome = "Bruno", Altura = 1.8 };
            ...
            var nome = propriedade.GetValue(obj);
        ...
        {
            Console.Write("Informe a parte do nome do(s) atletas(s) a serem selecionados:");
