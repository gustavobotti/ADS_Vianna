...
<body>
    <table style="width:100%">
        ...
        <tr>
          ...
          <td><?php $endereco = $_POST["endereco"]; retornaVazio($endereco); echo ucwords(strtolower($endereco); ?></td>
          <td><?php if (isset($_POST['profissao'])){
            echo "{$_POST['profissao']}";} ?></td>
          <td><?php $genero = $_POST["genero"]; $outroql = $_POST["outroql"]; retornaVazio($genero);
          if ($genero == 'Outro: ')
          {
            echo "$genero" . $outroql;
          } else {
          ...
          <td><?php $areasInteresse = $_POST['areasInteresse']; retornaVazio($areasInteresse);   
          ...
          <td><?php if (isset($_POST['promocoes'])){
            $promocoes = $_POST["promocoes"]; retornaVazio($promocoes);
			if ($promocoes == 'Sim')
			{
            echo "$promocoes";
			} else {
